...
import 'package:myapp/controllers/property_floor_area_controller.dart';
import 'property_floor_area_filter_screen.dart';

class PropertyFloorAreaScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (_) => PropertyFloorAreaController()..fetchFloorAreas(apiKey, postcode),
      child: Scaffold(
        appBar: AppBar(
          title: Text('Floor Areas for $postcode'),
        ),
        body: Consumer<PropertyFloorAreaController>(
